...
static inline int int_png_load(const char *name, unsigned char **buffer, int* xp, int* yp, int* bpp, bool alpha)
{
	...
	{
		printf("[png.c]: Error processing %s - please report (including image).\n", name);
